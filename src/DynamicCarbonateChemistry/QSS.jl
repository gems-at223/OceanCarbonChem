...
@kwdef struct DynamicCarbonateChemistry2{FT} <: AbstractContinuousFormBiogeochemistry
    α₁ :: FT = 0.0036        # s-1
...
required_biogeochemical_tracers(::DynamicCarbonateChemistry2) = (:c₁, :c₂, :c₃,:c₅,:c₆,:c₇)


@inline function (bgc::DynamicCarbonateChemistry2)(::Val{:c₁}, x, y, z, t, c₁, c₂, c₃,c₅,c₆,c₇)
