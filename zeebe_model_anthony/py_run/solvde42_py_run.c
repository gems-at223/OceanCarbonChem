...
#define SYMTCUPT 3.333333333e-12
#define VMAX 3.333333333e-11    /* Michaelis-Menten max upt. for CO2 */
...
#define SLOWC 0.30    /* fraction of correction def. = 1.0 */
#define ITMAX 400     /* def. = 30 max. number of iterations */
