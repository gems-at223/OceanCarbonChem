...
#define FORAMBORL2    /* FORAMW,FORAMOUD,FORAMOUL,FORAMGSD,FORAMGSL
...
#define BORTBULK 5.0*(432.*(SALINITY/35.)) /* [mumol/kg], DOE94	 */
...
/* =============== init concentrations ======================= */
  ...
  h2obulk = MOLH2O;
   ...
   fprintf(fppara,"d11boh3bulk [mumol/kg]   %f \n",kp7);
#endif
